...
<main id="main">
  ...
  <!-- <section id="clients" class="clients">
    <div class="container">
      ...
      <div class="section-title" data-aos="fade-up">
        <h2>Clientes</h2>
        <p>A Facite Web Design é uma agência de web design, onde a asatisfação do cliente, é a nossa prioridade. Sempre bunscando forneçer um trabalho sério e competente para os mesmos.</p>
      </div>
